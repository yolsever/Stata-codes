...
local data "C:\Users\kaany_000\Desktop\Research\Sam Hwang\Mturk\excel_files\matching\"
...
use agreed_data.dta
matchit n v3 using mike_split_space.dta, idu(v1) txtu(v21) 
br
...
// merge using workers_inst_name
merge m:m v3 using agreed_data.dta
